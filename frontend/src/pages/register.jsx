            ...
            <div className="w-full md:w-1/2 lg:w-3/5 p-8 lg:pl-36 flex flex-col justify-center box-border">
                ...
                >
                    ...
                    <div className="flex flex-col">
                        ...
                        />
                        {errors.username && (
                            <p className="text-gray-300 text-sm mt-1">{errors.username.message}</p>
                        )}
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        />
                        {errors.password && (
                            <p className="text-gray-300  text-sm mt-1">{errors.password.message}</p>
                        )}
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        {errors.confirmPassword && (
                            <p className="text-gray-300   text-sm mt-1">{errors.confirmPassword.message}</p>
                        )}
                    </div>
